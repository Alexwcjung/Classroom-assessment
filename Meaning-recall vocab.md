...
| **Interpretation** | GPT와 Gemini의 신뢰도는 **인간 채점자와 동일 수준(.96)** 으로 안정적임. <br> Llama는 상대적으로 낮은 점수를 보임. → **AI 채점이 신뢰도 저하 없이 적용 가능**함을 시사. |
...
### 🧩 RQ4.  Examining when and why LLMs and human raters differ in judgments on specific words
| 주요 결과 | 요약 |
|------------|-------|
