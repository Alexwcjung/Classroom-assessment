...
| **Section** | **Key Details** |
|--------------|----------------|
| **Participants** | - Speakers: 총 24명, 6개 영어 억양(AmE, BrE, Chinese, Indian, Korean, Mexican English) 참여. 전문가 평가자들이 각 화자의 **억양(accentedness)** 과 **이해 용이성(comprehensibility)** 을 5점 척도로 평가해 평균 4점 이상인 화자를 선별함. <br> - **Listeners:** 총 160명 (중국어, 한국어, 힌디어, 스페인어 L1 그룹 각 40명), 평균 23.8세, 평균 영어 학습 기간 6.5년. |
